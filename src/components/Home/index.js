...
import PetWatermark from "../petwatermark";
      ...
      <>
        ...
        <div className="home_container">
          <div className="description">
            ...
            <br />
            <p3>
              Before you home pet, be sure you are <br /> to take care of it
              properly
            </p3>
            ...
            <div className="review_container">
              ...
              <div className="review_value">
                ...
                <p5>
                  See user rating of us to see <br />
          ...
          <div className="img_container">
            <img src={urlFor(datas[0].image.asset._ref)} alt="image" />
          </div>
        </div>
          ...
          <div className="learn_container">
            <div className="learn_container2">
              <div className="blue_box">
                ...
                <div className="dogs">
                  <div className="dog1">
                    <div className="dog1_img">
                      <img src={dog1} alt="dog1" />
                    </div>
                    <div className="dog1_desc">
                      Super dog <br />
                      <br />
                      <span>see more</span>
                    </div>
                  ...
                  <div className="dog2">
                    <div className="dog2_img">
                      <img src={dog2} alt="dog2" />
                    </div>
                    <div className="dog2_desc">
                      cute dog <br />
                      <br />
                      <span>see more</span>
                    </div>
                  ...
                  <div className="dog3">
                    <div className="dog3_img">
                      <img src={dog3} alt="dog3" />
                    </div>
                    <div className="dog3_desc">
                      Sweet dog <br />
                      <br />
                      <span>see more</span>
                    </div>
              ...
              <div className="black_box">
                ...
                <div className="footer_desc">
                  Learn how to take care of your <br /> pet with proper guidance
                </div>
                <div className="social_icon">
                  <a
                    className="facebook"
                    href={datas[0].facebook_link}
                    target="_blank"
                  >
                    <BsFacebook />
                  </a>
